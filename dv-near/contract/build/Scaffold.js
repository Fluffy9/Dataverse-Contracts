...
let Scaffold = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({
  payableFunction: true
}), _dec4 = call({}), _dec5 = view(), _dec(_class = (_class2 = class Scaffold {
  constructor() {
    this.registry = "";
  ...
  requestData({
    ...
    const promise = promiseBatchCreate(this.registry);
    promiseBatchActionFunctionCall(promise, "newRequest", bytes(JSON.stringify({
      _input: _input,
      _oracle: _oracle,
      _bounty: _bounty,
      _expiresIn: 86_400_000_000_000,
      _callback: currentAccountId()
    })), attachedDeposit(), 30_000_000_000_000);
  }
  onDVRequestFilled({
    _request,
    _result
  ...
  getResults({
    ...
    return JSON.stringify({
      length: this.items,
      request: this.requests[_i],
      result: this.results[_i]
    });
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "requestData", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "requestData"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onDVRequestFilled", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "onDVRequestFilled"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getResults", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "getResults"), _class2.prototype)), _class2)) || _class);
function getResults() {
  const _state = Scaffold._getState();
  if (!_state && Scaffold._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Scaffold._create();
  if (_state) {
    Scaffold._reconstruct(_contract, _state);
  }
  const _args = Scaffold._getArgs();
  const _result = _contract.getResults(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Scaffold._serialize(_result, true));
}
function onDVRequestFilled() {
  const _state = Scaffold._getState();
  if (!_state && Scaffold._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Scaffold._getArgs();
  const _result = _contract.onDVRequestFilled(_args);
  Scaffold._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Scaffold._serialize(_result, true));
}
function requestData() {
  ...
  const _args = Scaffold._getArgs();
  const _result = _contract.requestData(_args);
  Scaffold._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Scaffold._serialize(_result, true));
}
function init() {
...
export { getResults, init, onDVRequestFilled, requestData };
