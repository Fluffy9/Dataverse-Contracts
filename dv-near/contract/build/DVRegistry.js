...
let DVRegistry = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = call({
  payableFunction: true
}), _dec6 = view(), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec(_class = (_class2 = class DVRegistry {
  constructor() {
    this.owner = "";
  ...
  newRequest({
    ...
    assert(attachedDeposit() == BigInt(_bounty), "Invalid bounty");
  ...
  cancelRequest({
    ...
    // send NEAR
    const promise = promiseBatchCreate(request.requestor);
    promiseBatchActionTransfer(promise, bounty);
  ...
  fillRequest({
    ...
    request.bounty = BigInt(0);
    this._DVCallback({
      _callback: this.requests.get(_id).callback,
      _request: _id,
      _result: _result
    });
    this.requests.set(_id, request);
  ...
  _DVCallback({
    ...
    const promise = promiseBatchCreate(_callback);
    promiseBatchActionFunctionCall(promise, "onDVRequestFilled", bytes(JSON.stringify({
      _request: _request,
      _result: _result
    })), 0, 30_000_000_000_000);
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setOwner", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "setOwner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getOwner", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getOwner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "newRequest", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "newRequest"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getRequest", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "getRequest"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "cancelRequest", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "cancelRequest"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "fillRequest", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "fillRequest"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "_DVCallback", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "_DVCallback"), _class2.prototype)), _class2)) || _class);
function _DVCallback() {
  const _state = DVRegistry._getState();
  if (!_state && DVRegistry._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = DVRegistry._create();
  if (_state) {
    DVRegistry._reconstruct(_contract, _state);
  }
  const _args = DVRegistry._getArgs();
  const _result = _contract._DVCallback(_args);
  DVRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function fillRequest() {
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.fillRequest(_args);
  DVRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function cancelRequest() {
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.cancelRequest(_args);
  DVRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function getRequest() {
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.getRequest(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function newRequest() {
  const _state = DVRegistry._getState();
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.newRequest(_args);
  DVRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function getOwner() {
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.getOwner(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function setOwner() {
  const _state = DVRegistry._getState();
  ...
  const _args = DVRegistry._getArgs();
  const _result = _contract.setOwner(_args);
  DVRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DVRegistry._serialize(_result, true));
}
function init() {
...
export { _DVCallback, cancelRequest, fillRequest, getOwner, getRequest, init, newRequest, setOwner };
//# sourceMappingURL=DVRegistry.js.map
